...
<div class="form payment-form">
 ...
 <div class="form-row col-4"><label for name=""> Account Number: </label><input type="text" name="accountnumber" id ="account-number" placeholder="Enter account number"></div>
 <div class="form-row col-4"><label for name="MmonthlDues"> Monthly Dues: </label><input type="text" name="monthlydues" id ="monthly-dues" class="input monthlydues"></div>
 <div class="form-row col-4"><label for name="MedicalPayment"> Medical Payment: </label><input type="text" name="medicalpayment" id = "medical-payment" class="input medicalpayment" ></div>
 <div class="form-row col-4"><label for name="DamayangFE"> Damayang FE: </label><input type="text" name="damayangfe" id = "damayang-fe" placeholder=""></div>
 <div class="form-row col-4"><label > Total Monthly Payment: </label><input type="text" name="totalmonthlypayment" id="total-monthly-payment" onblur="getTotal()"></div>
 <div class="form-row col-4"><label for name="nextduedate"> Next Due Date: </label><input type="date" name="nextduedate" id = "next-duedate" placeholder="Enter next due date"></div>
 </div>
...
function display_custom_form() {
    ...
    <?php echo "<td>".$return->dateofpayment."</td></tr>"?>
